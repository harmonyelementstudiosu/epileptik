function AddHud() {
    ...
    const oldRadmirConfig = {
        ...
        "wanted_back": "",
        "weapon_back": "",
        "zone": "" // Иконка по умолчанию пустая
        },
    weapon: {
        "0": "",
        "1": "",
...
.hud-param-value {
  ...
  `;
    ...
    // --- ВАРИАНТЫ ИКОНОК ЗЕЛЕНОЙ ЗОНЫ ---
    // Выберите один из следующих вариантов, удалив комментарии "//" перед ним.
    // Убедитесь, что другой вариант закомментирован.

    // Вариант 1: Иконка из репозитория Font Awesome (через GitHub Raw)
